...
export const ALL_PERMISSIONS: Permission[] = [
  ...
  { id: "projects:read",        resource: "projects",        action: "read",   description: "View project portfolio, work items, milestones, and project health" },
  { id: "projects:manage",      resource: "projects",        action: "manage", description: "Create, update, and manage project records and work streams" },
  { id: "risks:read",           resource: "risks",           action: "read",   description: "View project risks and risk prioritization" },
  { id: "risks:manage",         resource: "risks",           action: "manage", description: "Create and manage mitigation plans and project risks" },
  { id: "integrations:read",    resource: "integrations",    action: "read",   description: "View third-party integration status and configuration" },
  { id: "integrations:manage",  resource: "integrations",    action: "manage", description: "Create external work and manage external integration actions" },
  { id: "intelligence:read",    resource: "intelligence",    action: "read",   description: "Query project intelligence and AI-assisted summaries" },
  { id: "intelligence:manage",  resource: "intelligence",    action: "manage", description: "Manage AI-assisted project intelligence and review actions" },
];
